...
DEPARTURE_HOUR = os.getenv('DEPARTURE_HOUR')
EV_CHARGER_SPEED_KW = os.getenv('EV_CHARGER_SPEED_KW')
EV_BATTERY_CAPACITY_KWH = os.getenv('EV_BATTERY_CAPACITY_KWH')
EV_CHARGE_LIMIT_PERCENT = os.getenv('EV_CHARGE_LIMIT_PERCENT')
